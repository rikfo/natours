...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicmlrZm8iLCJhIjoiY2ttbTQ1aXA3MWd0dTJ2cWtoazBkOW9nNCJ9.ENcog7O-9i35qVO8YsBppQ';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, " : ").concat(loc.description, "</p>")); // Extend map bounds to include currecnt location
...
var stripe = Stripe('pk_test_51IgGbnHh9siSimrGfYm8C6MWh0bfX8OuS0XxIB53p7Jg4rLtCm30fr5u5T8iFlZOfS6eglxjn6z6aVi1AqSlW82D00URi8jQo5');
...
if (formUserSettings) {
  formUserSettings.addEventListener('submit', function (e) {
    e.preventDefault();
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "33499" + '/');
